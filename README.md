...
Обратите внимание: используется самоподписанный сертификат, поэтому браузер может показывать предупреждение о небезопасном соединении. Для доступа необходимо принять риск и продолжить.
